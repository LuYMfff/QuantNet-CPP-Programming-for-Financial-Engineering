...
int main()
{
	...
	cout << s.ToString() << endl; // Print shape with ID.
	cout << p.ToString() << endl; // Print point with ID.
	cout << l.ToString() << endl; // Print line with ID.
	...
	cout << sp->ToString() << endl; // What is printed? Point(10,20) with ID
