...
namespace NELSON
{
	namespace CAD
	{
		Line::Line() : StartPoint(0.0, 0.0), EndPoint(0.0, 0.0) // Default constructor
		{
		}

		Line::Line(const Point& pt1, const Point& pt2) : StartPoint(pt1), EndPoint(pt2) //Constructor with a start- and end-point
		{
		}

		Line::Line(const Line& ln) // Copy constructor
		{
