...
int main()
{
	...
	cout << "After negating Point 1, it becomes " << (-pt).ToString() << endl;

	// Scale the coordinates.
	cout << "2 times Point 1 is " << (pt * 2).ToString() << endl;

	// Add coordinates.
	cout << "After adding up Point 1 and point 2, it becomes " << (pt + pt2).ToString() << endl;
	...
	cout << "After multipying Point 1 by 2, it becomes " << (pt *= 2).ToString() << endl;
